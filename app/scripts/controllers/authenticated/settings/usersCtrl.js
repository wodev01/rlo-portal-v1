...
app.controller('UsersCtrl',
    function ($scope, $mdSidenav, $mdDialog, $stateParams, userService) {
        ...
        $scope.userAction = '<div layout="row"> ' +
            '<md-button aria-label="Edit User" class="md-icon-button md-primary" ng-click="grid.appScope.fnUserEdit(row,$event);">' +
            ...
            '</md-button>' +
            '<md-button aria-label="Delete User" class="md-icon-button md-warn" ng-click="grid.appScope.fnUserDelete(row,$event)">' +
