...
app.controller('LocationsCtrl',
    function ($scope, $mdSidenav, $rootScope, $mdDialog, $timeout, locationService) {
        ...
        $scope.locationAction = '<div layout="row">' +
            '<md-button aria-label="Open Location" class="md-icon-button md-primary" ng-click="grid.appScope.fnLocationEdit(row)">' +
            ...
            '<md-button aria-label="Delete Location" class="md-icon-button md-warn" ng-click="grid.appScope.fnLocationDelete(row,$event);">' +
